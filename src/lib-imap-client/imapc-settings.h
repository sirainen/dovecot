...
enum imapc_features {
	...
	IMAPC_FEATURE_NO_SORT			= 0x20,
	IMAPC_FEATURE_ZIMBRA_WORKAROUNDS	= 0x40,
	IMAPC_FEATURE_NO_EXAMINE		= 0x80,
	IMAPC_FEATURE_PROXYAUTH			= 0x100,
	IMAPC_FEATURE_FETCH_MSN_WORKAROUNDS	= 0x200,
	IMAPC_FEATURE_FETCH_FIX_BROKEN_MAILS	= 0x400,
	IMAPC_FEATURE_NO_MODSEQ			= 0x800,
	IMAPC_FEATURE_NO_DELAY_LOGIN		= 0x1000,
	IMAPC_FEATURE_NO_FETCH_BODYSTRUCTURE	= 0x2000,
	IMAPC_FEATURE_SEND_ID			= 0x4000,
	IMAPC_FEATURE_FETCH_EMPTY_IS_EXPUNGED	= 0x8000,
	IMAPC_FEATURE_NO_MSN_UPDATES		= 0x10000,
	IMAPC_FEATURE_NO_ACL 			= 0x20000,
	IMAPC_FEATURE_NO_METADATA		= 0x40000,
	IMAPC_FEATURE_NO_QRESYNC		= 0x80000,
	IMAPC_FEATURE_NO_IMAP4REV2		= 0x100000,
};
/* </settings checks> */
